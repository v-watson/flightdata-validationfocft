...
# VERSION 3.1 - Sorties - Reads TrialSummaryFile and copies Sortie Data for date of interest

import linecache
import re

date_str = input("Enter date in format YYYY-MM-DD: ")
full_date_str = "%s" % (date_str)
...
for line in readfile:
    matchObj = re.search(full_date_str, line, re.X|re.I)
    line_count += 1
